<?php
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true){
      header('location:/php-auth/index.php');//checking if the session is already started, if so it will be redirected to to home page
      exit;
    }
...
<?php include_once('./header.php') ?>
  ...
  <a href="/php-auth/signup.php" class="btn btn-primary">Vous n'avez pas ncore un compte ? s'inscrire ici</a>
</form>
    </section>
</body> 
</html>